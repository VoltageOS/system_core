...
bool LoadKernelModules(BootMode boot_mode,  ExternalPortState external_port_state, bool want_console,
...
#undef CHECKCALL
    ...
    if (!LoadKernelModules(boot_mode, external_port_state, want_console, want_parallel_mode, want_parallel_test,
                           module_count)) {
